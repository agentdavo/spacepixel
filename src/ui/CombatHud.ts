...
import { FACING_NAMES, ZONE_NAMES, type Subsystem } from '@/sim/Damage';
 ...
 *   (selected, then exposed, then shielded, then wrecked) with a kill feed
 *   row ("TURRET 3 DESTROYED") on top for a few seconds.
