...
V3 timed script · 25 September 2026 · 152.967-second picture edit.

The introduction moves from lost infrastructure to fuel, political power and
the people living between the two factions. It then yields to sustained combat
before returning to the unexplained signal. These are original Vanguard lines.
The Kessen remain outside this introduction; the campaign's major revelations
are withheld.
...
| ---: | ---: | --- |
| 2.500 | 7.149 | For twenty-two centuries, the stars were neighbours. |
| 9.000 | 16.113 | The Lantern gates joined the human worlds. Then, in a single day, they went dark. |
...
| 135.000 | 139.982 | And beyond the last light, something is counting down. |

## Picture and sound

| Picture time | Sequence | Direction |
| --- | --- | --- |
| 0–18 | The lost roads | Small ships approach an inactive Lantern. Sparse score and engine texture establish scale. |
| 18–30 | Life among wreckage | Actual flight HUD through the graveyard connects history to play. |
| 30–45 | The living route | Active gate and freighter traffic introduce the economy and Ebon-gas stakes. |
...
the hull. The game does not currently provide a modelled fighter cockpit
interior. Shield displays, target selection and hull/subsystem state come from
the native HUD.

Per-shot sources, offsets, input recordings and validation accompany the media
in `scratchpad/delivery/v3/`. The common subtitle timing stays below 14 characters
per second and clears the action section at 81 seconds. Numerical timing and
level checks do not constitute a human audition of the voice performances.
